<?php
namespace App\Repositories\PmMessage;

use App\Repositories\BaseRepositoryWrap;

class PmMessageRepository extends BaseRepositoryWrap
{
    /**
    ...
    protected $configEndpoint = [
        'list' => '/api/v1/pmmessage/list',
        'create' => '/api/v1/pmmessage/create',
        'update' => '/api/v1/pmmessage/update',
        'delete' => '/api/v1/pmmessage/delete',
    ];
    ...
    protected $routeAliasName = [
        'create' => 'pmmessage.create',
        'update' => 'pmmessage.update',
        'delete' => 'pmmessage.delete',
    ];
    ...
    protected $action = [
        ...
        'edit' => true,
        'dele' => true,
        'route_list' => 'pmmessage.view',
        'route_detail' => 'pmmessage.detail',
        'route_edit' => 'pmmessage.submit.update',
        'route_dele' => 'pmmessage.submit.delete',
    ];
     ...
     * @var string
     */
    protected $configListSearch = 'pmmessage.list';
    ...
    protected $configCreate = 'pmmessage.create';

    /**
     * set config update attribute
     * @var string
     */
    protected $configUpdate = 'pmmessage.update';
    /**
     * set route search action
     * @get form alias naming router.
     * @var string
     */
    protected $routeAction = 'pmmessage.view';
