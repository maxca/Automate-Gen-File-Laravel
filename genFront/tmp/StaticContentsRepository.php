 ...
 */
namespace App\Repository\StaticContents;

use App\Repository\BaseRepositoryWrap;

class StaticContentsRepository extends BaseRepositoryWrap
{
    /**
     * set title name default
     * @var string
     */
    protected $name = 'static-contents';
    ...
    protected $configEndpoint = [
        'list' => '/static-contents/list',
        'create' => '/static-contents/create',
        'update' => '/static-contents/update',
        'delete' => '/static-contents/delete',
    ];
    ...
    protected $configView = [
        'list' => 'staticcontents.list',
        'edit' => 'staticcontents.edit',
        'create' => 'staticcontents.create',
        'detail' => 'staticcontents.detail',
    ];
